...
public class ConcolicConfig {
	...
	public void addConcolicMethod(String id,
								  String className,
								  String methodName,
								  AnalysisConfig ac,
								  ParamConfig... params) {
	...
	public static TerminationStrategy parseTerminationStrategy(String line) {
		try {
			...
			Logger.getLogger("jdart")
				  .log(Level.WARNING,
					   "Could not instantiate termination strategy: " + ex.getClass().getSimpleName() + " / " +
					   ex.getMessage(),
					   ex);
		}
		return new NeverTerminate();
	...
	public static class MethodConfig {
		...
		public String toString() {
			return this.className + "." + this.methodName + "(" + Arrays.toString(paramNames) + ":" +
