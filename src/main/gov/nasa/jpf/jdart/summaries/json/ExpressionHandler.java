 ...
 *
 */
public class ExpressionHandler implements JsonSerializer<Expression<?>>, JsonDeserializer<Expression<?>> {
	...
	@Override
	public Expression<?> deserialize(JsonElement je, Type type, JsonDeserializationContext jdc) throws
			JsonParseException {
		try {
