...
public class FloatConstantFilter extends AbstractExpressionVisitor<Boolean, Void> implements ExpressionFilter {
	 ...
	 * .NumericBooleanExpression, D)
	 */
	@Override
	public Boolean visit(NumericBooleanExpression n, Void data) {
	 ...
	 */
	@Override
	public <E> Boolean visit(NumericCompound<E> n, Void data) {
		return visit(n.getLeft()) && visit(n.getRight());
	}
	 ...
	 */
	@Override
	public <E> Boolean visit(UnaryMinus<E> n, Void data) {
