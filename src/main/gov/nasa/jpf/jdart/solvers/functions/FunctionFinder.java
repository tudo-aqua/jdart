...
public class FunctionFinder extends AbstractExpressionVisitor<Expression, Collection<FunctionExpression>> {
	 ...
	 * .NumericExpressionExpression, D)
	 */
	@Override
	public NumericBooleanExpression visit(NumericBooleanExpression n, Collection<FunctionExpression> data) {
	 ...
	 */
	@Override
	public <F, E> CastExpression<F, E> visit(CastExpression<F, E> cast, Collection<FunctionExpression> data) {
	 ...
	 */
	@Override
	public <E> NumericCompound<E> visit(NumericCompound<E> n, Collection<FunctionExpression> data) {
		Expression left = visit(n.getLeft(), data);
		Expression right = visit(n.getRight(), data);
	 ...
	 */
	@Override
	public <E> UnaryMinus<E> visit(UnaryMinus<E> n, Collection<FunctionExpression> data) {
		return new UnaryMinus(visit(n.getNegated(), data));
	}

	/* (non-Javadoc)
	 * @see gov.nasa.jpf.constraints.api.ExpressionVisitor#visit(gov.nasa.jpf.constraints.expressions
	 * .QuantifierExpression, D)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see gov.nasa.jpf.constraints.api.ExpressionVisitor#visit(gov.nasa.jpf.constraints.expressions.BitvectorNegation,
	 *  java.lang.Object)
	 */
	@Override
